...
int main(int argc, const char* argv[]) {
  ...
  // auto img_tensor = torch::CPU(torch::kFloat32).from_blob(img_float.data, {1, 224, 224, 3});
  auto img_tensor = torch::from_blob(img_float.data, {1, 224, 224, 3}, at::kFloat);
  img_tensor = img_tensor.permute({0,3,1,2});//.toType(at::kFloat).div_(255);
